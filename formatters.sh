...
cpplint --exclude=lib/ --exclude=cmake-build-debug/ --exclude=build/ --exclude=CMakeFiles --filter=-legal/copyright,-build/include_subdir,-build/c++11,-build/include_order --recursive .
